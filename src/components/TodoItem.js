        ...
        return connectDragSource(
            connectDropTarget( 
                <li className={firstLoad ? "todoItem scale-in-center" : "todoItem"} ref={this.setListRef} style={{ opacity }}>
                    <button className="dragTodo"><img src="/img/drag.svg" alt="Drag todo item" /></button>
                    {
                        isEditing ?
                            <EditModal
                                index={index}
                    ...
                    <div className="todoDetails">
                        <div className="todoSVGs">
                            <svg className={isComplete ? "checkbox icon fillCheckbox" : "checkbox icon emptyCheckbox"} onClick={completeToggle} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
